...
def parse_station(city, station):
    '''
    ...
    end_date = datetime(year=2015, month=7, day=13)
    ...
    with open('{}.csv'.format(station), 'w') as out_file:
        ...
        while current_date != end_date:
            ...
            with open('{}/{}-{}-{}.html'.format(station,
                ...
                weather_data = soup.find(id='historyTable').find_all(
                    'span', class_='wx-value')
                weather_data_units = soup.find(
                    id='historyTable').find_all('td')
                ...
                try:
                    ...
                    out_file.write(
                        '{}-{}-{},'.format(current_date.year, current_date.month, current_date.day))
